...
function realtimeDevice(deviceId) {
    ...
    $.ajax({
        ...
        success: function (data) {//success为请求成功后的回调函数
            ...
            url = 'ws://39.104.84.131:8080/api/ws/plugins/telemetry?token=' + token; // eyJhbGciOiJIUzUxMiJ9..XPq489vRt3CSpqdY6kzr5DNBvhyCcnezFK4DUAgQTjVkiVqjDEPN_jGKgdb9dKA_aiXVdWptkWOjLwJqubFpjA' ;
