...
define(function (require) {
    ...
    var tpl = require('text!offlinePM/content.html');
    ...
    // pie
        ...
        a=99;
            ...
            $scope.line = function (){
                ...
                $scope.pieShow = false;
                $scope.lineActive = !$scope.lineActive;
            }
            $scope.barActive = false;
            $scope.bar = function (){
                $scope.hz = "时间";
                ...
                $scope.lineActive = false;
                $scope.pieShow = false;
                $scope.barActive = !$scope.barActive;
            }
    $scope.bugLineEndDate = new Date();
    $scope.bugLineStartDate = new Date($filter('date')(new Date(), 'yyyy-01-01T00:00:00'));
    $scope.pieShow = false;
    $scope.pie = function (){
        $scope.hz = "时间";
        $scope.zz = "Pm2.5";
