...
var schema = [
    ...
    {name: 'AQIindex', index: 1, text: '温度'},
    {name: 'PM25', index: 2, text: '湿度'},
    {name: 'PM10', index: 3, text: '风力'},
    {name: 'CO', index: 4, text: ' 光照'},
    {name: 'NO2', index: 5, text: '紫外线'},
    {name: 'SO2', index: 6, text: 'PM2.5'},
    {name: '等级', index: 7, text: '测量平均值'}
];
