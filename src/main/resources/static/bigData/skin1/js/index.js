                ...
                if (myXmlHttpRequest2.readyState == 4) {
                    ...
                    if(mes == ""){
                        ...
                        if(meso.status == 'success'){
                            ...
                            var myChart = echarts.init(document.getElementById('chart_1'),'dark');
                            ...
                            // 基于准备好的dom，初始化echarts实例
                            var myChart1 = echarts.init(document.getElementById('chart_2'),'dark');
                            ...
                            // 基于准备好的dom，初始化echarts实例
                            var myChart2 = echarts.init(document.getElementById('chart_3'),'dark');
                            ...
                            var myChart3 = echarts.init(document.getElementById('chart_4'),'dark');
                            option3 = {
                                backgroundColor:'',
                                title: {
                                    text: '正常数据比例',
